...
plt.errorbar(N_table, varxx_table, yerr=odchxx_table, fmt='o', capsize=5, markersize = 1, label="Dane z niepewnościami")
plt.xscale('log')
plt.show()
...
# X1, Y1 = np.loadtxt("Monte_carlo_6_zad_2_t_100.txt", delimiter=" ", unpack=True, usecols=(0, 1))
...
# plt.savefig("t=100.jpg")
# plt.show()

# X2, Y2 = np.loadtxt("Monte_carlo_6_zad_2_n_omega100_1.txt", delimiter=" ", unpack=True, usecols=(0, 1))
# plt.figure(figsize=(6,6))
# plt.xlabel("t")
# plt.ylabel("n")
# plt.title(r"$R_a = 0.5, \omega = 100$")
# plt.savefig("Ra_05_omega_100.jpg")
# plt.plot(X2, Y2, "red")
# plt.show()
