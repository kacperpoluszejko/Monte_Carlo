...
V = np.loadtxt('Monte_carlo_9_1.txt')  # domyślny separator to spacja
V2 = np.loadtxt('Monte_carlo_9_2.txt')
sigma = np.loadtxt('Monte_carlo_9_1_sigma.txt')
S = np.loadtxt('Monte_carlo_9_1_chains.txt')
